...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libstm_chronos.${CND_DLIB_EXT}: ${OBJECTFILES}
	...
	${LINK.cc} -shared -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libstm_chronos.${CND_DLIB_EXT} -fPIC ${OBJECTFILES} ${LDLIBSOPTIONS} 

${OBJECTDIR}/stm_chronos.o: stm_chronos.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/stm_chronos.o stm_chronos.cpp
